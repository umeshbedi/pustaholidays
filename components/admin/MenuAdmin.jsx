...
export default function MenuAdmin({ menuClick }) {
  ...
  const menuItems = [
    ...
    {
      key: "activityAndaman", menu: <p><FaSwimmer /> Activities</p>, subMenu: [
    ...
    {
      key: null, menu: <p><FaEye /> Popular Islands</p>, subMenu: [
    ...
    {
      key: "rentalAndaman", menu: <p><FaCar /> Rentals</p>, subMenu: [
